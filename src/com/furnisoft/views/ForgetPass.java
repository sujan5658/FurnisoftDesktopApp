...
import com.furnisoft.services.Mailer;
...
public class ForgetPass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Please enter the registered email address.");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/furnisoft/icons/email.png"))); // NOI18N

        recoverButton.setText("Recover Account");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(recoverButton, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(51, 51, 51))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(recoverButton, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void recoverButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recoverButtonActionPerformed
        ...
        if(varEmail.equals("") || varEmail==null){
            JOptionPane.showMessageDialog(null,"Email required.!!!","Empty Field",JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            try{
                Mailer mail = new Mailer();
                Message message = new Message(); 
                message = mail.checkEmail(varEmail);
                if(message.isMessageStatus()){
                    JOptionPane.showMessageDialog(null,message.getMessage(),"Error !!!!",JOptionPane.ERROR_MESSAGE);
                }
                else{
                    try{
                        mail.sendEmail(varEmail);
                        JOptionPane.showMessageDialog(null,message.getMessage(),"Verification Send",JOptionPane.INFORMATION_MESSAGE);
                        this.dispose();
                    }catch(Exception er){
                        JOptionPane.showMessageDialog(null,"Internal Error..!! Try later...","Error !!!!",JOptionPane.ERROR_MESSAGE);
                    }
